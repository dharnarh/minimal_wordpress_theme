...
<div class="container-fluid rmpd">
  <div class="uf-top-banner" style="background-image: url(<?php echo get_bloginfo('template_directory'); ?>/assets/img/black.jpg); background-position: center; background-size: cover; background-repeat: no-repeat; background-origin: initial">
    <div class="uf-banner flexbox text-center">
      <div class="mx-auto align-self-center pb-5">
        ...
        <a target="_blank" href="https://linkedin.com/in/humarh-dharnarh"><span class="gh mr-0 fa fa-linkedin"></span></a>
      </div>
    </div>
  </div>
</div>
